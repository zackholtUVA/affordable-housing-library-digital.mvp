...
export function SiteFooter() {
  return (
    <footer className="mt-28 border-t border-[var(--border)] bg-[var(--surface)]">
      <div className="mx-auto flex w-full max-w-[86rem] flex-col gap-10 px-[var(--space-page-x)] py-16">
        <p className="max-w-3xl text-sm text-[var(--muted)]">{GLOBAL_DISCLAIMER}</p>
        <nav className="flex flex-wrap items-center gap-7 text-xs text-[var(--muted)]">
